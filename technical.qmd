...
This training material has been developed by:

* Alice Byers, RAP Developer, Scottish Government

  [Email](mailto:alice.byers@gov.scot) | [GitHub](https://github.com/alicebyers5)

* David French, Statistician, National Records of Scotland

  [Email]() | [GitHub]()
  
The code used to produce these slides is available on [GitHub](https://github.com/ScotGovAnalysis/version-control-guidance).
