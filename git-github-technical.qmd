...
-   The collaborators should now be able to clone, pull, edit, commit and push etc. 

-   If multiple people are working on a file simultaneously, then their changes will be automatically merged when they push their edits. If there are conflicts in their code, then this will be flagged and they will be asked to review and fix the conflicts. 
...
NB: This isn’t the OneDrive Documents folder, but the one on your actual C drive; your code will run faster if it’s stored on the C drive. 
...
5. You should also see a “Git” tab in the top right quadrant (next to Environment, History and Connections). Click this, then check all the boxes under “Staged”, then click “Commit”. 
6. Enter a commit message (e.g., “Initial commit”), and then click “Commit”.

## Initial project setup - RStudio  
7. Click “Push”, then “Close”. A successful push will result in a message something like: 
...
Remember to modify your gitignore file to ensure that data files aren’t stored on github. Normally this can be done by adding “\*.csv”, “\*.xls”, “\*.sas7bdat” to the file (new line for each filetype, and without the quotation marks). You should also update the readme file periodically. 
